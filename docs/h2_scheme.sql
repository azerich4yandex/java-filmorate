...
CREATE TABLE IF NOT EXISTS RELATIONSHIPS (
	...
	CONSTRAINT RELATIONSHIPS_RELATIONSHIP_TYPES_FK FOREIGN KEY (TYPE_ID) REFERENCES RELATIONSHIP_ATTRIBUTES(ID) ON DELETE SET NULL,
	CONSTRAINT RELATIONSHIPS_RELATIONSHIP_STATUSES_FK FOREIGN KEY (STATUS_ID) REFERENCES RELATIONSHIP_ATTRIBUTES(ID) ON DELETE SET NULL
);
...
CREATE TABLE USERS_RELATIONSHIPS (
	...
	CONSTRAINT USERS_RELATIONSHIPS_USERS_FK FOREIGN KEY (USER_ID) REFERENCES USERS(ID) ON DELETE CASCADE,
	CONSTRAINT USERS_RELATIONSHIPS_RELATIONSHIPS_FK FOREIGN KEY (RELATIONSHIP_ID) REFERENCES RELATIONSHIPS(ID) ON DELETE CASCADE
);

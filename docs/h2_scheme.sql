...
COMMENT ON COLUMN USERS_FILMS.MARK IS 'Оценка фильма';
...
CREATE TABLE FILMS_DIRECTORS (
  ...
  CONSTRAINT FILMS_DIRECTORS_FILM_ID_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS (ID) ON DELETE CASCADE,
  CONSTRAINT FILMS_DIRECTORS_DIRECTOR_ID_FK FOREIGN KEY (DIRECTOR_ID) REFERENCES DIRECTORS (ID) ON DELETE CASCADE
);
